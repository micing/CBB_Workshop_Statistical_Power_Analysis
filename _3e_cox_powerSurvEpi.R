...
hr=c(.5, .6, .7, .8) +.1 # assumed Hazard Ratios
alpha = .05 # The tests type-1 error rate
power = .90 # statistical power needed
ptreat = 1/3 # .proportion of subjects treated/exposed
rho2 = .1 # confounding: square of the correlation between covariate of interest and other covariates 

cases = seq(1,300) # the range of cases (outcomes) to calculate and plot
...
#### View data for 88 cases ####

statistical_power %>% filter(cases==88) %>% view
